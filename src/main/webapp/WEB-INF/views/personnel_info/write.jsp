	...
	<main class="main-content position-relative border-radius-lg ">
		...
		<script type="text/javascript">
			...
			function checkForm(x){
				...
				x.form.action = "/personnel_info/write";
		        x.form.method="post";
		        x.form.submit();
			};
			$(function(){
						...
						<form action="" method="post" enctype="multipart/form-data">
								...
								<table id="register-table" class="table">
									...
									<tr>
										...
										<td colspan="3">
											<textarea class="form-control" id="summernote" name="bocontents"></textarea>
										</td>
									</tr>
									<tr>
										<th class="th-title"><label for="formFileSm" class="form-label">파일</label></th>
										<td colspan="2">
											<input type="file" class="form-control form-control-sm" name="file" id="file" onchange="fileDelete(this)">
											
											</td><td><a id="fileDeletebtn"  onclick="emptyFile()">X</a>
										</td>
									</tr>
									<tr>
										<td colspan="4">
