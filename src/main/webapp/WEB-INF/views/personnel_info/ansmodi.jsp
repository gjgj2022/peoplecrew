...
<br /><br />
					...
					<form action="ansmodi" method="post">
					<div class="container answerpart">
						<table class="table">
						<thead>
						<tr>
						<td colspan="2"><h5>답변하기</h5>
						<input type="hidden" name="ansno" value="${ans.ansno}"/>
					<input type="hidden" name="bono" value="${ans.bono}"/>
						</td>
						</tr>
						</thead>
							<tr>
										...
										<td colspan="3">
											<input type="text" class="form-control" name="anstitle" id="exampleFormControlInput1" placeholder="답변제목을 입력해주세요." value="${ans.anstitle }"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="3">
											<textarea class="form-control" id="anscontents" name="anscontents" placeholder="답변 내용을 입력해주세요." rows="8">${ans.anscontents }</textarea>
										</td>
									</tr>
						</tr>
						<tr>
								...
								<a href="/personnel_info/detail?bono=${boarddto.bono }"> <input type="button" value="취소" class="btn" /></a> 
								  ...
								  <input type="submit" value="답변 등록하기" class="btn" />
