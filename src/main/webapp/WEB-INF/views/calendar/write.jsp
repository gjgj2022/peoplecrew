...
<div class="container outline">
	...
	<form action="/calendar/write" method="post" id="calform" name="calform">
		...
		<div class="row">
			<div class="col-auto">
				<div class="form-group">
					...
					<select class="form-select" name="uno" id="uno" aria-label="Default select example">
		...
		<input type="hidden" id="updatemno" name="updatemno" value=${user.mno}>
	...
	function radiocheck(checked) {
		if (checked.checked == true) {
			if (checked.value == 2) {
				...
				$("#uno").val(1);
				var a = '<input type="hidden" name="uno" value=1>';
				$('#updatemno').append(a);
			} else {
