...
<div class="container outline">
	<div class="detailbody">
		...
		<div class="container">
			<div class="card-body text-lg-left pt-0">
				...
				<div class="d-flex justify-content-lg-start p-2">
					...
					<div>
						<span class="ps-3">장소 : ${dto.calloc}</span>
					</div>
				</div>
				...
				<div class="d-flex justify-content-lg-start p-2">
					...
					<div>
						<span class="ps-3">시작 : ${dto.calstart }</span>
					</div>
				</div>
				...
				<div class="d-flex justify-content-lg-start p-2">
					...
					<div>
						<span class="ps-3">종료 : ${dto.calend }</span>
					</div>
				</div>
				...
				<div class="d-flex justify-content-lg-start p-2">
					...
					<div>
						<span class="ps-3">내용 : ${dto.calcontents }</span>
					</div>
				</div>
		...
		<div class="modal-footer justify-content-center detailfooter">
			...
			<c:if test="${not empty dto.updatemname }">
				<span class="ps-3">마지막 수정 : ${dto.updatemname }, ${dto.updatedate }</span>
			</c:if>
		</div>
	</div>
</div>
