...
<body>
	...
	<div style="width:750px;margin-left:auto;margin-right:auto;">
			...
			<div class="" style="font-size:30px;text-align:center;">연차신청서</div>
			<br />
	<table class="table table-bordered align-middle">
		...
		<tr>
			...
			<td class="border" colspan="4"><textarea class="bg-white" name="docontents3" id="" cols="30" rows="10" style="width:550px; border:none;" onkeydown="resize(this)" onkeyup="resize(this)" disabled>${dto.docontents3 }</textarea></td>
		</tr>
	</table>
	</div>
</body>
