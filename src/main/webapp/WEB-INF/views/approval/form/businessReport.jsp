...
<body>
	...
	<table class="table table-bordered align-middle">
		...
		<tr>
			...
			<td colspan="3"><textarea name="docontents" id="ta1" cols="30" rows="10" style="width:100%; border:none;" onkeydown="resize(this)" onkeyup="resize(this)">${ddto.docontents }</textarea></td>
		</tr>
		<tr>
			<td class="bg-secondary p-2 text-dark bg-opacity-10 w-25" style="text-align:center;">건의사항</td>
			<td colspan="3"><textarea name="docontents2" id="ta2" cols="30" rows="6" style="width:100%; border:none;" onkeydown="resize(this)" onkeyup="resize(this)">${ddto.docontents2 }</textarea></td>
		</tr>
		<tr>
