...
<body>
	...
	<table class="table table-bordered align-middle">
		...
		<tr>
			...
			<td class="border" colspan="4"><textarea name="docontents3" id="ta3" cols="30" rows="6" style="width:550px; border:none;" onkeydown="resize(this)" onkeyup="resize(this)">${dto.docontents3 }</textarea></td>
		</tr>
	</table>
	</div>
</body>
