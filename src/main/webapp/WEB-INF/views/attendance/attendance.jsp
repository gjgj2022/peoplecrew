...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <!-- 좌측 사이드바 -->
    <ul class="navbar-nav" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#c-nav" data-bs-toggle="collapse" href="#">
         <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <ul id="c-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="/attendance?mno=${dto.mno }" class="nav-link active">
              <span>근태관리</span>
            </a>
          </li>
          <li>
