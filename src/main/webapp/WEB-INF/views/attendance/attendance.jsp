                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="text-align: center;">상세보기</th>
                    </tr>
                  </thead>
                  <tbody>
                  <c:forEach var="dto" items="${list }">
                    <tr>
                      <td>
                        <p class="text-sm font-weight-bold mb-0" style="text-align: center;">${dto.work_day }</p> <!-- 날짜 -->
                      </td>
                      <td>
                      ...
                      <td>
                        <p class="text-sm font-weight-bold mb-0" style="text-align: center;">${dto.oname }</p> <!-- 부서 -->
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0" style="text-align: center;">${dto.start_time }</p> <!-- 출근시간 -->
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0" style="text-align: center;">${dto.end_time }</p> <!-- 퇴근시간 -->
                      </td>
                      <td>
                     	<!-- <c:if test="${dto.state == '확인1' }" >출근중</c:if>  -->
                        <p class="text-sm font-weight-bold mb-0" style="text-align: center;">${dto.state }</p> <!-- 상태정보 -->
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0" style="text-align: center;">
						<input type="button" value="상세보기" class="btn btn-ligh"/></p> <!-- 상세보기 -->
                      </td>
                    </tr>
                  </c:forEach>
                    <tr>
